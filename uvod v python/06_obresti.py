...
def pretvori_v_letno_obrestno_mero(mesecna_obrestna_mera):
    ...
    return round(letna_obrestna_mera * 100)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjIsInVzZXIiOjExNDIyfQ:1vusMI:cyqksQBGdeHXv7FwyoaI67FYzfVSCny6E4EN52LJt5Y"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjMsInVzZXIiOjExNDIyfQ:1vusMI:9ANCnhT63b86ta1vaRopEEiF-vsphPp9XMxGJYcm4fc"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MzUsInVzZXIiOjExNDIyfQ:1vusMI:xTr0akJt1hZOONOuWesaPThKjKQccjSX5vuh_3bQz1c"
        try:
