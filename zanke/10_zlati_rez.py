...
def natancni_priblizek(eps):
    prejsnji = 1
    trenutni = naslednji_priblizek(1)
    while abs(trenutni - prejsnji) >= eps:
        prejsnji, trenutni = trenutni, naslednji_priblizek(trenutni)
    return trenutni
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMDAwLCJ1c2VyIjoxMTQyMn0:1w2UFZ:_cIPv9jYP39aoFGrkzMntwrTVMc5KxqqwF0JYv8zJIU"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMDAxLCJ1c2VyIjoxMTQyMn0:1w2UFZ:vyEU1ElbP5Zww-tWL5J9kRMyFnD6QPovuUxprPJyoSA"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMDAyLCJ1c2VyIjoxMTQyMn0:1w2UFZ:-NwBnKJn87GJrAw0X-3Klllhz2zLmAiRrdsB7MQZ5ec"
        try:
