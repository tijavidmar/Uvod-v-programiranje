...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDI0MywidXNlciI6MTE0MjJ9:1wWE7D:1ZwxiH2GRYySCUHyJeM5IemwQPQj4Oj0CwHcAx--j4w"
        try:
            primeri = [
                (
                    "primer1a.py",
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDIwOSwidXNlciI6MTE0MjJ9:1wWE7D:J50XWNiA2dUJ2e2FhFkw1-RtgjrpWoPC9pGo3I6ryo8"
        try:
            primeri = [
                (
                    "primer2a.py",
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDIxMCwidXNlciI6MTE0MjJ9:1wWE7D:kCbojANyFQp9Sy71UxDVBhZqrWcgqw5sXpKuUqwoTUU"
        try:
            primeri = [
                (
                    "primer3a.py",
