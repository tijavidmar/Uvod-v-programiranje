...
#     "-RACUN---0000010\nCena: 50 EUR\nDDV: 11\nSkupno: 61\nHvala za obisk"
# ============================================================================= 
def turist(st_racuna, cena, davek):
    st_racuna_str = str(st_racuna).zfill(7)
    ddv = int(cena * davek / 100)
    skupno = cena + ddv
    racun = (f"-RACUN---{st_racuna_str}\n"
             f"Cena: {cena} EUR\n"
             f"DDV: {ddv}\n"
             f"Skupno: {skupno}\n"
             f"Hvala za obisk")
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5MywidXNlciI6MTE0MjJ9:1vzwtr:YrJSLS1mUZGvvSzHUd7hVnMYSk2CddxSC5jhFDOjS5s"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5NCwidXNlciI6MTE0MjJ9:1vzwtr:K3AEz_IgncOaKSPn-pKtg29RCsczHON08LyTRJTFpcc"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5NSwidXNlciI6MTE0MjJ9:1vzwtr:McLIQ0HrSocbYeM9HLylDh1XwAQmcyrfRWL7H4XPFEU"
        try:
