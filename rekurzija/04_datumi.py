...
def je_prestopno(leto):
    return leto % 4 == 0 and leto % 100 != 0 or leto % 1000 == 0
# =====================================================================@000928=
# 2. podnaloga
...
def je_veljaven_datum(dan, mesec, leto):
    if mesec <= 12 and mesec > 0:
        if dan <= stevilo_dni(mesec, leto) and dan > 0:
            return True
        else:
            return False
    else:
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjcsInVzZXIiOjExNDIyfQ:1vusMI:WSIn8IP-Tx3BmmhkzN9-KviixQSKgCObZmEoZWSEmxA"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjgsInVzZXIiOjExNDIyfQ:1vusMI:6S1OCf5Tm-Zh7hXAjapdvkOxSGXwbwNFWR5DOQcGWJo"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjksInVzZXIiOjExNDIyfQ:1vusMI:y1cz8fyHVlk3Hm6nGbme5BtqevEZLeWHopiQcHbu4pU"
        try:
