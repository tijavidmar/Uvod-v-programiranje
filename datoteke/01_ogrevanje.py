...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDM0NiwidXNlciI6MTE0MjJ9:1wFA2g:UXyJk56uaqs0LEeuy37CXD6NAQqp2oFCmoSTc3qXW0g"
        try:
            test_cases = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDM0NywidXNlciI6MTE0MjJ9:1wFA2g:Uv-P6Wr7yC64GQFm5HydwTzuHFgga5T6sFk1cAn_IPs"
        try:
            test_cases = [
