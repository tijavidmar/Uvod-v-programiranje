...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNTE4LCJ1c2VyIjoxMTQyMn0:1wFA2g:sDe6ca5GnjAEVZjLTcuta-jZow20fSlRoRH1MKsWC8w"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNTE5LCJ1c2VyIjoxMTQyMn0:1wFA2g:d6Qb1BITY7mJWsvQ1R-jgL6mOXi0veF81gr6lElpLL8"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNTIwLCJ1c2VyIjoxMTQyMn0:1wFA2g:cyyEIB3MMbsVQrO7EbhgNfcJbwXGpMdIyPmHeS5AIlQ"
        try:
            test_data = [
                ("kolokviji_vhod.txt", ["Janez Novak,1,3,3,2,0", "Micka Kovaceva,0,3,2,3", "Miha Praznic", "Peter Klepec,1,0,1,2,1,3"],
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNTIxLCJ1c2VyIjoxMTQyMn0:1wFA2g:oTi2aTCfSYwl8I6sBvZRTLHVK8ZEW9nDR04a67XnQis"
        try:
            test_data = [
