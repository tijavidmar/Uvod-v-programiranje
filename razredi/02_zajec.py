...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzA2LCJ1c2VyIjoxMTQyMn0:1wCcep:ySRUCVyqR9BPe0ARsuYaoK5zUXqy_ewjRcwPSoDMEIc"
        try:
            test_data = [
                ('Zajec(5, 3).teza', 5),
                ('Zajec(5, 3).starost', 3),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzA3LCJ1c2VyIjoxMTQyMn0:1wCcep:SfdcLiwCgyskIIw98ghHBROgbKiAqD3_mfpf4A-cDDg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzA4LCJ1c2VyIjoxMTQyMn0:1wCcep:5q_ZLd6mz4ZSLAKoX1y1pnPy_b2IAMKjIacJgAe0YNI"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzA5LCJ1c2VyIjoxMTQyMn0:1wCcep:Y726fT5wDD7xVBztB6MwPlojZWXHfIdk6fkX10xAoXU"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzEwLCJ1c2VyIjoxMTQyMn0:1wCcep:r_AGQPa3wK_duaOnGjPW43LyCWxy3PaW10pjpbeK4Ck"
        try:
            prav = (
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzExLCJ1c2VyIjoxMTQyMn0:1wCcep:1g2YZy27ZHaLa-LXsjOX-ns9mmCOysdAbZLca8uP1rY"
        try:
