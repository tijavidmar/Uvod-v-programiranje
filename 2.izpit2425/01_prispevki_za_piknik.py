...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjk5NywidXNlciI6MTE0MjJ9:1wWqil:Cl-K72ArIz9WQ7j7ddjFSUjnCKZZdWFpl9QT1-JHU28"
        try:
            prispevki1 = {}
            prispevki2 = {"Cene": {}}
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjk5OSwidXNlciI6MTE0MjJ9:1wWqil:1cWw4SOa0JsBDdSaHnfo_qEu2JqVzd2PGRJOAJG_5Fc"
        try:
            prispevki1 = {}
            prispevki2 = {"Cene": {}}
            prispevki3 = {"Alenka": {"radler": 3}, "Bojan": {"radler": 4}}
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MzAwMCwidXNlciI6MTE0MjJ9:1wWqil:l_njwPyOzQ0VbWWVXMFDe9fxA4Tpn_8_xVHaijbtZcY"
        try:
            rezultat1 = {
                "Alenka": 1.7,
                "Cene": 11.9,
