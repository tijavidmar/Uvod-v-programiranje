...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjk5MywidXNlciI6MTE0MjJ9:1wWqil:DBxsIebSRdD_GNbykIE5YSJuBLVsVh_8cEr3zyefeTs"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjk5NCwidXNlciI6MTE0MjJ9:1wWqil:sXEgtDvDJcfainxEyh-Oo1QOKO6HsEndXNIXZng_qII"
        try:
            podatki = [
                (3, [1, 5, 0, 4], 2, 17),
                (3, [], 3, 0),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjk5NSwidXNlciI6MTE0MjJ9:1wWqil:NH2FJ40FzIIF-UNgurV8shbXGy5Y5B4S5yx6l2Kq4Ug"
        try:
            podatki = [
