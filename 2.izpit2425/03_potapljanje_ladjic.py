...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjk4MiwidXNlciI6MTE0MjJ9:1wWqil:ywmLMWyb21IaMRqhzLEc9aaX2ksdLqp639_rsU5HJHg"
        try:
            tests = [
                (['3,3,v,3'], 3, [[' ', ' ', ' '], [' ', ' ', ' '], [' ', ' ', ' ']]),
                (['3,3,v,3', '1,2,>,2'], 3, [[' ', '#', '#'], [' ', ' ', ' '], [' ', ' ', ' ']]),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjk4NCwidXNlciI6MTE0MjJ9:1wWqil:rxKA9dV4nMPPo-6hKh-o9FR_YVTPthlOwfT52GVQxWk"
        try:
            tests = [
                ([[' ', ' ', ' '], [' ', ' ', ' '], [' ', ' ', ' ']], "/---\\\n|   |\n|   |\n|   |\n\\---/"),
                ([[' ', '#', '#'], [' ', ' ', ' '], [' ', ' ', ' ']], "/---\\\n| ##|\n|   |\n|   |\n\\---/"), 
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjk4MywidXNlciI6MTE0MjJ9:1wWqil:S0vzChYV2gdXuhFVHHjrWXn3-kPbtz56FK0iirrL0TE"
        try:
            tests = [
                (['5,5'], ['3,3,v,3'], 3, [[' ', ' ', ' '], [' ', ' ', ' '], [' ', ' ', ' ']]),
                (['5,2', '2,5'], ['3,3,v,3'], 3, [[' ', ' ', ' '], [' ', ' ', ' '], [' ', ' ', ' ']]),
