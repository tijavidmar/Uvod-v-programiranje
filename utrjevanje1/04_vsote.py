...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNDc0LCJ1c2VyIjoxMTQyMn0:1wA5Hi:TMgFbep4Uw6afVUDQhPe8us2et3UCZHFYw6HSL1urNE"
        try:
            test_data = [
                ("""vsota_kvadratov(1)""", 1),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNDc1LCJ1c2VyIjoxMTQyMn0:1wA5Hi:lx7pt8FEQMfRqv9hBlyAU5FGGSX4Utu6FhI68fG8Rpk"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNDc2LCJ1c2VyIjoxMTQyMn0:1wA5Hi:tukrLk15pqNHniqy_S50pAzvo-uoP26Ir43Vtyz1sV0"
        try:
            test_data = [
                ("""stevilo_clenov(2)""", 1),
                ("""stevilo_clenov(19)""", 2),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNDc3LCJ1c2VyIjoxMTQyMn0:1wA5Hi:w75NrvLqmTaI7BlRmCeYTxwcN-hys27M8C-5NsUraY0"
        try:
            test_data = [
