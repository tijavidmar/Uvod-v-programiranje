...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjk2MywidXNlciI6MTE0MjJ9:1wWYEn:r7PFMXLGMMRR09ieSUtziJcZW1tOiRtytGL1jYoGLw0"
        try:
            pogovor1 = {
                'naslov': 'Kam gremo jest?',
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjk2MSwidXNlciI6MTE0MjJ9:1wWYEn:wkeGMbM6Be2O_dT3DiewNhdVUw1FvPPMIkvkaCBih98"
        try:
            pogovor1 = {
                'naslov': 'Kam gremo jest?',
                'sporocila': [('Tea', 'jaz bi šla v menzo :thumbsup:'), ('Aljaž', 'meni v menzi ne diši, a bi šlo raje v Hombre?'), ('Martin', 'meni je vseeno, zmente se')]
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjk2MiwidXNlciI6MTE0MjJ9:1wWYEn:YNlwa8Xo6Y3-8Nc0YxbJza-5Ubj7JrqhEcaCkwz2-_Q"
        try:
            pogovor1 = {
                'naslov': 'Kam gremo jest?',
                'sporocila': [('Tea', 'jaz bi šla v menzo :thumbsup:'), ('Aljaž', 'meni v menzi ne diši, a bi šlo raje v Hombre?'), ('Martin', 'meni je vseeno, zmente se')]
