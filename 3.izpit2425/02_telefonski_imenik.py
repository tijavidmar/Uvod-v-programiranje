...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MzAyMywidXNlciI6MTE0MjJ9:1wWrOn:Wi7o6EV5e1OxFzIuk5th5qA69_ftNhXFZ6bqTp6i8UA"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MzAyNCwidXNlciI6MTE0MjJ9:1wWrOn:Wt3qLNXDBgQuC41AwtqN45yk5RlJc4ySRYGZsWbFIGs"
        try:
            Check.run(
                [
                    'i = Imenik()',
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MzAyNSwidXNlciI6MTE0MjJ9:1wWrOn:_TgaBzZL_Q7M1gKEmxg5j3VTBloyi96WEtgU2482P1o"
        try:
            Check.run(
                [
                    'i = Imenik()',
