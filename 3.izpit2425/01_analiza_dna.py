...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MzAyMSwidXNlciI6MTE0MjJ9:1wWrOn:XptVg57SlQ3Fcid-oOzv2cxh00_j4vTgDHx68i99ay0"
        try:
            testni_primeri = [
                ('ATGGCTA', 'TACCGAT'),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MzAyMCwidXNlciI6MTE0MjJ9:1wWrOn:_Aiymd91yTsboh7op0T_47xx8P5QDq381XLqqlbHNwo"
        try:
            testni_primeri = [
                ('ATGGCTA', 0, ['ATG', 'GCT']),
                ('ATGGCTA', 1, ['TGG', 'CTA']),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MzAyMiwidXNlciI6MTE0MjJ9:1wWrOn:GXpYiq6QDlDhCPrg8I0JZeoZflI9AQoSDjaQnczYndM"
        try:
            testni_primeri = [
                (['ATG', 'TAA'], ['ATG', 'TAA']),
                (['ATG', 'TAG'], ['ATG', 'TAG']),
