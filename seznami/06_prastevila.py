...
def prastevila_do(n):
    ...
    for stevilo in range(2, n + 1):
        je_prastevilo = True
        for i in range(2, stevilo // 2 + 1):
            if stevilo % i == 0:
                je_prastevilo = False
                break
        if je_prastevilo:
            prastevila.append(stevilo)
    return prastevila         
# =====================================================================@009811=
# 3. podnaloga
...
def je_prastevilo(n):
    ...
    if n <= 1:
        return False
    for stevilo in range(2, n // 2 + 1):
        if n % stevilo == 0:
            je_prastevilo = False
            break
    return je_prastevilo
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODA5LCJ1c2VyIjoxMTQyMn0:1w51fQ:LviUDb_sbpHAHEtm-fqpEHz7sQTDPcLhl6kh2FcvHcI"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODEwLCJ1c2VyIjoxMTQyMn0:1w51fQ:M1HhFi-7EakcP4pBbW8EktYd6fWzymmf6d4VR4QkWYg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODExLCJ1c2VyIjoxMTQyMn0:1w51fQ:DOataV45bYbLyet6oDrTPskWkg8rAeNxFwwVz9ZwHek"
        try:
