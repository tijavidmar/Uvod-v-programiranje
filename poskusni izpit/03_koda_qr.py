...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0NDc1NCwidXNlciI6MTE0MjJ9:1wKEh5:oO34UtzHnTy6BB9z3dyitLBlgfC6SlA9SjhgwrrkfmM"
        try:
            env = {'qr': KodaQR(3, 4)}
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0NDc1NSwidXNlciI6MTE0MjJ9:1wKEh5:SL1vMowpCSZdrlk7mS295F4pLPXuky4loP09ee_7A0o"
        try:
            qr = KodaQR(3, 4)
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0NDc1NiwidXNlciI6MTE0MjJ9:1wKEh5:ERoKTm0rkyoMOZEmYnfxTuJs8wpjSX6JiVfPeUf9mfo"
        try:
            qr = KodaQR(3, 4)
