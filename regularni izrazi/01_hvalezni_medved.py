...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzM5NywidXNlciI6MTE0MjJ9:1wMm3K:vkMjEhTh2zZkkykY8hAlmWMCxuJMFRjmQlFk22qN_Xg"
        try:
            Check.equal(
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzM5OSwidXNlciI6MTE0MjJ9:1wMm3K:wCbcAP1z2PyGEz8oDs_mvDzhKlMZBg8f2QDQELVqjqM"
        try:
            hvalezni_medved = """Gori nekje v gorah, ne ve se več, ali je bilo pri Macigoju ali
            Naravniku, je šivala gospodinja v senci pod drevesom in zibala otroka. Naenkrat
            prilomasti - pa prej ni ničesar opazila - medved in ji moli taco, v kateri je
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzQwMSwidXNlciI6MTE0MjJ9:1wMm3K:KXzO_0agT9Kouo38c_71apH7HRNzBcXrve29rox3gnc"
        try:
            hvalezni_medved = """Gori nekje v gorah, ne ve se več, ali je bilo pri Macigoju ali
            Naravniku, je šivala gospodinja v senci pod drevesom in zibala otroka. Naenkrat
            prilomasti - pa prej ni ničesar opazila - medved in ji moli taco, v kateri je
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzQwMCwidXNlciI6MTE0MjJ9:1wMm3K:txfYuMszsNvtfVq4vYyzHZdxSxeyq1KM1jbkANLcTGY"
        try:
            hvalezni_medved = """Gori nekje v gorah, ne ve se več, ali je bilo pri Macigoju ali
            Naravniku, je šivala gospodinja v senci pod drevesom in zibala otroka. Naenkrat
            prilomasti - pa prej ni ničesar opazila - medved in ji moli taco, v kateri je
