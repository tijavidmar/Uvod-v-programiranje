...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDIyNSwidXNlciI6MTE0MjJ9:1wWVJd:h64PX9pg_eH-Lx7bY9CE3zk1nOjt6mKXAmY6bFYRRB4"
        try:
            def preveri_dv():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDIyNCwidXNlciI6MTE0MjJ9:1wWVJd:x7OSvWexs4miAZ0wyEqNgFM38GJoqNmjCu2VDHc3ILg"
        try:
            def preveri_sz():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDIyNiwidXNlciI6MTE0MjJ9:1wWVJd:RHfA6xHmRS0SHazhB37nqhziPrkONEuQO5mkxqXObrE"
        try:
            def preveri_am():
